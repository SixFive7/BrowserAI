...
**Status: shipped at `v1.0.0`.** Work settled in intent but not yet done lives in [`TODO.md`](TODO.md); open design questions stay in the README, and the [hazard index](plan/hazards.md#hazard-index) is in the plan. *Corrected 2026-08-17 (previously "design phase, nothing is built") — it was the first factual claim an agent read, and every rule below was read through it.*
